...
export default function BlogItem() {
    const { item } = useParams(); // Access the dynamic route parameter

    const [pageName, setPageName] = useState(item);
    const [linkImage, setLinkImage] = useState('../../images/thumbs/single/single-02.jpg');

    useEffect(() => {
        // Update the page name when the item changes
        if (item) {
            switch (item) {
                case 'audio-post':
                    setPageName('Audio Post');
                    setLinkImage('../../images/thumbs/single/single-02.jpg');
                    break;
                case 'gallery-post':
                    setPageName('Video Post');
                    setLinkImage('../../images/thumbs/single/single-03.jpg');
                    break;
                case 'video-post':
                    setPageName('Gallery Post');
                    setLinkImage('../../images/thumbs/single/gallery/single-gallery-01.jpg');
                    break;
                case 'standard-post':
                    setPageName('Standard Post');
                    setLinkImage('../../images/thumbs/single/single-01.jpg');
                    break;
            }
        }
    }, [item]);
                ...
                <div className="col-twelve">
                    ...
                    <article className="format-video">
                        ...
                        <div className="primary-content">
                            ...
                            <h1 className="entry-title">Hey, This Is {pageName} Post.</h1>
                            ...
                            <form name="contactForm" id="contactForm" method="post" action="">
                                <fieldset>
                                    ...
                                    <div className="message form-field">
                                        <textarea name="cMessage" id="cMessage" className="full-width" placeholder="Your Message" defaultValue="" ></textarea>
                                    </div>
