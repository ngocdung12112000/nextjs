                    ...
                    <div className="col-four tab-1-3 mob-full footer-subscribe">
                        ...
                        <div className="subscribe-form">
                            ...
                            <form id="mc-form" className="group" >
                                <input type="email" name="dEmail" className="email" id="mc-email" placeholder="Type &amp; press enter"  required defaultValue=""/>
                                <input type="submit" name="subscribe" defaultValue=""/>
