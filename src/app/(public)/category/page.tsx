      ...
      <section id="bricks" className="with-top-sep">
        ...
        <div className="row masonry">
          ...
          <div className="bricks-wrapper" style={{position: 'relative', height: '2521px'}}>
            ...
            <article className="brick entry format-standard animate-this" style={{position: 'absolute', left: '0px', top: '739px'}}>
            ...
            <article className="brick entry format-gallery group animate-this" style={{position: 'absolute', left: '50%', top: '756px'}}>
            ...
            <article className="brick entry format-standard animate-this" style={{position: 'absolute', left: '0', top: '1585px'}}>
            ...
            <article className="brick entry format-standard animate-this" style={{position: 'absolute', left: '50%', top: '1592px'}}>
